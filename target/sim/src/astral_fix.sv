...
`endif
  ...
  astral_wrap i_dut (
    ...
    .pad_botl_jtag_ot_trst_ni_pad ( w_jtag_secd_trstn ),
    .pad_botl_jtag_ot_tms_pad     ( w_jtag_secd_tms ),
    .pad_botl_jtag_ot_tdi_pad     ( w_jtag_secd_tdi ),
    .pad_botl_jtag_ot_tdo_pad     ( w_jtag_secd_tdo ),
    // Hyper
    .pad_botl_hyper_cs_0_n_pad    ( w_hyper_csn[0][0] ),
    .pad_botl_hyper_cs_1_n_pad    ( w_hyper_csn[0][1] ),
    .pad_botl_hyper_ck_pad        ( w_hyper_ck[0] ),
    .pad_botl_hyper_ck_n_pad      ( w_hyper_ckn[0] ),
    .pad_botl_hyper_rwds_pad      ( w_hyper_rwds[0] ),
    .pad_botl_hyper_dq_0_pad      ( w_hyper_dq[0][0] ),
    .pad_botl_hyper_dq_1_pad      ( w_hyper_dq[0][1] ),
    .pad_botl_hyper_dq_2_pad      ( w_hyper_dq[0][2] ),
    .pad_botl_hyper_dq_3_pad      ( w_hyper_dq[0][3] ),
    .pad_botl_hyper_dq_4_pad      ( w_hyper_dq[0][4] ),
    .pad_botl_hyper_dq_5_pad      ( w_hyper_dq[0][5] ),
    .pad_botl_hyper_dq_6_pad      ( w_hyper_dq[0][6] ),
    .pad_botl_hyper_dq_7_pad      ( w_hyper_dq[0][7] ),
    .pad_botl_hyper_reset_n_pad   ( w_hyper_resetn[0] ),
    // SPW
    // .pad_botl_spw_data_in_pad     ( w_spw_data_in    ),
    // .pad_botl_spw_strb_in_pad     ( w_spw_strobe_in  ),
    // .pad_botl_spw_data_out_pad    ( w_spw_data_out   ),
    // .pad_botl_spw_strb_out_pad    ( w_spw_strobe_out ),
    // UART
    .pad_botl_uart_tx_out_pad     ( w_uart_hostd_tx ),
    .pad_botl_uart_rx_in_pad      ( w_uart_hostd_rx )
    // Muxed pads
    // .pad_botl_muxed_v_00_pad      ( w_muxed_v_00 ),
    // .pad_botl_muxed_v_01_pad      ( w_muxed_v_01 ),
    // .pad_botl_muxed_v_02_pad      ( w_muxed_v_02 ),
    // .pad_botl_muxed_v_03_pad      ( w_muxed_v_03 ),
    // .pad_botl_muxed_v_04_pad      ( w_muxed_v_04 ),
    // .pad_botl_muxed_v_05_pad      ( w_muxed_v_05 ),
    // .pad_botl_muxed_v_06_pad      ( w_muxed_v_06 ),
    // .pad_botl_muxed_v_07_pad      ( w_muxed_v_07 ),
    // .pad_botl_muxed_v_08_pad      ( w_muxed_v_08 ),
    // .pad_botl_muxed_v_09_pad      ( w_muxed_v_09 ),
    // .pad_botl_muxed_v_10_pad      ( w_muxed_v_10 ),
    // .pad_botl_muxed_v_11_pad      ( w_muxed_v_11 ),
    // .pad_botl_muxed_v_12_pad      ( w_muxed_v_12 ),
    // .pad_botl_muxed_v_13_pad      ( w_muxed_v_13 ),
    // .pad_botl_muxed_v_14_pad      ( w_muxed_v_14 ),
    // .pad_botl_muxed_v_15_pad      ( w_muxed_v_15 ),
    // .pad_botl_muxed_v_16_pad      ( w_muxed_v_16 ),
    // .pad_botl_muxed_v_17_pad      ( w_muxed_v_17 ),
    // .pad_botl_muxed_h_00_pad      ( w_muxed_h_00 ),
    // .pad_botl_muxed_h_01_pad      ( w_muxed_h_01 ),
    // .pad_botl_muxed_h_02_pad      ( w_muxed_h_02 ),
    // .pad_botl_muxed_h_03_pad      ( w_muxed_h_03 )
  );

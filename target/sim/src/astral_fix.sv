...
`endif
  ...
  `ifdef GF22_FLL
    localparam time       ClkPeriodRef  = 56.790ns; // 17.61MHz default reference clock generated by the FLL
  `else
...
`endif
  ...
  astral_wrap i_dut (
    ...
    // Hyper
    .pad_hyper_phy0_cs_n_0_pad      (w_hyper_csn[0][0] ),
    .pad_hyper_phy0_cs_n_1_pad      (w_hyper_csn[0][1] ),
    .pad_hyper_phy0_ck_pad          (w_hyper_ck[0] ),
    .pad_hyper_phy0_ck_n_pad        (w_hyper_ckn[0] ),
    .pad_hyper_phy0_rwds_pad        (w_hyper_rwds[0] ),
    .pad_hyper_phy0_dq_b0_pad       (w_hyper_dq[0][0] ),
    .pad_hyper_phy0_dq_b1_pad       (w_hyper_dq[0][1] ),
    .pad_hyper_phy0_dq_b2_pad       (w_hyper_dq[0][2] ),
    .pad_hyper_phy0_dq_b3_pad       (w_hyper_dq[0][3] ),
    .pad_hyper_phy0_dq_b4_pad       (w_hyper_dq[0][4] ),
    .pad_hyper_phy0_dq_b5_pad       (w_hyper_dq[0][5] ),
    .pad_hyper_phy0_dq_b6_pad       (w_hyper_dq[0][6] ),
    .pad_hyper_phy0_dq_b7_pad       (w_hyper_dq[0][7] ),
    .pad_hyper_phy0_reset_n_pad     (w_hyper_resetn[0] ),
    .pad_hyper_phy1_cs_n_0_pad      (w_hyper_csn[1][0] ),
    .pad_hyper_phy1_cs_n_1_pad      (w_hyper_csn[1][1] ),
    .pad_hyper_phy1_ck_pad          (w_hyper_ck[1] ),
    .pad_hyper_phy1_ck_n_pad        (w_hyper_ckn[1] ),
    .pad_hyper_phy1_rwds_pad        (w_hyper_rwds[1] ),
    .pad_hyper_phy1_dq_b0_pad       (w_hyper_dq[1][0] ),
    .pad_hyper_phy1_dq_b1_pad       (w_hyper_dq[1][1] ),
    .pad_hyper_phy1_dq_b2_pad       (w_hyper_dq[1][2] ),
    .pad_hyper_phy1_dq_b3_pad       (w_hyper_dq[1][3] ),
    .pad_hyper_phy1_dq_b4_pad       (w_hyper_dq[1][4] ),
    .pad_hyper_phy1_dq_b5_pad       (w_hyper_dq[1][5] ),
  ...
  */
  ...
  if (CarfieldIslandsCfg.secured.enable) begin: gen_secured_vip
    ...
    localparam time ClkPeriodSecdJtag = ClkPeriodJtag;
...
task automatic select_phy_startup(input int unsigned sel);
  // Controllo validità
  if (sel >= NumPhys) begin
    $fatal(1, "[fixture] CAR_PHY_SEL=%0d out of range (NumPhys=%0d)", sel, NumPhys);
  end

  $display("[fixture] Startup PHY selection -> CAR_PHY_SEL=%0d", sel);

  // Selezione PHY non selezionata
  if (sel == 0) begin
    // Usiamo PHY 0 
    // Disconnette PHY 1
    // Chip 0
    force car_vip.hyperrams[1].chips[0].dut.DQ7 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.DQ6 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.DQ5 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.DQ4 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.DQ3 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.DQ2 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.DQ1 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.DQ0 = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.RWDS = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.CK    = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.CKNeg = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.RESETNeg = 1'bz;
    force car_vip.hyperrams[1].chips[0].dut.CSNeg = 1'bz;

    // Chip 1
    force car_vip.hyperrams[1].chips[1].dut.DQ7 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.DQ6 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.DQ5 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.DQ4 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.DQ3 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.DQ2 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.DQ1 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.DQ0 = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.RWDS = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.CK    = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.CKNeg = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.RESETNeg = 1'bz;
    force car_vip.hyperrams[1].chips[1].dut.CSNeg = 1'bz;

  end else if (sel == 1) begin
    // Usiamo PHY 1 
    // Disconnette PHY 0
    // Chip 0
    force car_vip.hyperrams[0].chips[0].dut.DQ7 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.DQ6 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.DQ5 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.DQ4 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.DQ3 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.DQ2 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.DQ1 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.DQ0 = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.RWDS = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.CK    = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.CKNeg = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.RESETNeg = 1'bz;
    force car_vip.hyperrams[0].chips[0].dut.CSNeg = 1'bz;

    // Chip 1
    force car_vip.hyperrams[0].chips[1].dut.DQ7 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.DQ6 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.DQ5 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.DQ4 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.DQ3 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.DQ2 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.DQ1 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.DQ0 = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.RWDS = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.CK    = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.CKNeg = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.RESETNeg = 1'bz;
    force car_vip.hyperrams[0].chips[1].dut.CSNeg = 1'bz;
  end

  $display("[fixture] PHY %0d enabled, other PHYs forced to Z", sel);
endtask

...
create_clock -name CLK_HYP -period $period_hyperbus [get_pins i_carfield/i_hyperbus_wrap/CLK]
create_generated_clock -name CLK_PHY -source [get_pins i_carfield/i_hyperbus_wrap/CLK] -add -master_clock CLK_HYP -edges {1 3 5} [get_pins i_carfield/i_hyperbus_wrap/i_hyper_clk_gen/clk_phy_o_reg/Q]

create_generated_clock -name CLK_PHY0_CK \
    -add \
    -master_clock [get_clocks CLK_HYP] \
    -source [get_pins i_carfield/i_hyperbus_wrap/CLK] \
    -edges {2 4 6} \
...
# RWDS clock
create_generated_clock [get_pins i_carfield/i_hyperbus_wrap/i_hyperbus/i_phy/phy_wrap.phy_unroll[0].i_phy/i_trx/i_delay_rx_rwds_90/in_i] \
                       -name CLK_RWDS_0 -edges {1 2 3} -edge_shift "$clk_rx_shift $clk_rx_shift $clk_rx_shift" \
                       -source [get_ports pad_hyper_rwds[0]]
create_generated_clock [get_nets i_carfield/i_hyperbus/i_phy/phy_wrap.phy_unroll[0].i_phy/i_trx/rx_rwds_clk_n] \
                        -name CLK_RWDS_SAMPLE_0 -invert  -divide_by 1  \ 
                        -source [get_pins i_carfield/i_hyperbus_wrap/i_hyperbus/i_phy/phy_wrap.phy_unroll[0].i_phy/i_trx/i_delay_rx_rwds_90/in_i] 
                        
create_generated_clock [get_pins i_carfield/i_hyperbus_wrap/i_hyperbus/i_phy/phy_wrap.phy_unroll[1].i_phy/i_trx/i_delay_rx_rwds_90/in_i] \
                       -name CLK_RWDS_1 -edges {1 2 3} -edge_shift "$clk_rx_shift $clk_rx_shift $clk_rx_shift" \
                       -source [get_ports pad_hyper_rwds[1]]
create_generated_clock [get_nets i_carfield/i_hyperbus/i_phy/phy_wrap.phy_unroll[1].i_phy/i_trx/rx_rwds_clk_n] \
                        -name CLK_RWDS_SAMPLE_1 -invert  -divide_by 1  \ 
                        -source [get_pins i_carfield/i_hyperbus_wrap/i_hyperbus/i_phy/phy_wrap.phy_unroll[1].i_phy/i_trx/i_delay_rx_rwds_90/in_i]                           
...
set_false_path -from [get_pins i_carfield/i_carfield_reg_top/u_hyperbus_clk_div_value/*reg*/C]
set_false_path -from [get_pins i_carfield/i_carfield_reg_top/u_hyperbus_clk_div_en/*reg*/C]
set_false_path -from [get_pins i_carfield/i_hyperbus_wrap/i_hyper_rstgen/i_rstgen_bypass/*reg*/C]


##  CDC between Cheshire (Host Domain) and Hyperbus (Periph Domain)
set_max_delay -datapath -from [get_pins i_carfield/i_hyperbus_wrap/i_hyper_axi_cdc_dst/i_cdc_fifo_gray_*/*reg*/C] -to [get_pins i_carfield/i_cheshire_wrap/i_cheshire_ext_llc_cdc_src/i_cdc_fifo_gray_*/i_spill_register/spill_register_flushable_i/*reg*/D] 20
set_max_delay -datapath -from [get_pins i_carfield/i_cheshire_wrap/i_cheshire_ext_llc_cdc_src/i_cdc_fifo_gray_*/*reg*/C] -to [get_pins i_carfield/i_hyperbus_wrap/i_hyper_axi_cdc_dst/i_cdc_fifo_gray_*/i_spill_register/spill_register_flushable_i/*reg*/D] 20
set_max_delay -datapath -from [get_pins i_carfield/i_hyperbus_wrap/i_hyper_axi_cdc_dst/i_cdc_fifo_gray_*/*reg*/C] -to [get_pins i_carfield/i_cheshire_wrap/i_cheshire_ext_llc_cdc_src/i_cdc_fifo_gray_*/*i_sync/*reg*/D] 20
set_max_delay -datapath -from [get_pins i_carfield/i_cheshire_wrap/i_cheshire_ext_llc_cdc_src/i_cdc_fifo_gray_*/*reg*/C] -to [get_pins i_carfield/i_hyperbus_wrap/i_hyper_axi_cdc_dst/i_cdc_fifo_gray_*/*i_sync/*reg*/D] 20
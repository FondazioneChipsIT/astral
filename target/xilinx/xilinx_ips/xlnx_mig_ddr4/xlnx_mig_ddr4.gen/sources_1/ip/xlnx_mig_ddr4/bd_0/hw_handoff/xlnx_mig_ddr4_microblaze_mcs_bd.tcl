...
################################################################
# This is a generated script based on design: bd_f0c7
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./xlnx_mig_ddr4.gen/sources_1/ip/xlnx_mig_ddr4/bd_0

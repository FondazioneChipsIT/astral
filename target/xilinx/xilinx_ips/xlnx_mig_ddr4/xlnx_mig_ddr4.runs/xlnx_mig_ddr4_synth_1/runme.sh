...
HD_PWD='/data2/fseratini/astral-vcu118-v2/target/xilinx/xilinx_ips/xlnx_mig_ddr4/xlnx_mig_ddr4.runs/xlnx_mig_ddr4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xlnx_mig_ddr4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xlnx_mig_ddr4.tcl

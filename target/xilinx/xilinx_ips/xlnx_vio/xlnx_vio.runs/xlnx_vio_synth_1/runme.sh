...
HD_PWD='/data2/fseratini/astral-vcu118-v2/target/xilinx/xilinx_ips/xlnx_vio/xlnx_vio.runs/xlnx_vio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xlnx_vio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xlnx_vio.tcl

...
#define CAR_L2_SPM_PORT0_INTERLEAVED_END_ADDR(BASE)  (BASE + 0x10000)
#define CAR_L2_SPM_PORT0_CONTIGUOUS_BASE_ADDR(BASE)  BASE
#define CAR_L2_SPM_PORT0_CONTIGUOUS_END_ADDR(BASE)   (BASE + 0x10000)
...
#define CAR_PAD_CFG_OFFSET           0x01000000
#define CAR_L2ECC_CFG_OFFSET         0x01001000
// 0x01002000 -> SOC Control Offset
#define CAR_FLL_CFG_OFFSET           0x01003000
#define CAR_HYPERBUS_CFG_OFFSET      0x01004000

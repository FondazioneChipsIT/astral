...
#define CARFIELD_ETH_CLK_DIV_EN_REG_OFFSET 0xec
#define CARFIELD_ETH_CLK_DIV_EN_ETH_CLK_DIV_EN_BIT 0

// Ethernet clock divider value
#define CARFIELD_ETH_CLK_DIV_VALUE_REG_OFFSET 0xf0
#define CARFIELD_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_MASK 0xfffff
#define CARFIELD_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_MASK, .index = CARFIELD_ETH_CLK_DIV_VALUE_ETH_CLK_DIV_VALUE_OFFSET })

// Hyperbus clock divider enable bit
#define CARFIELD_HYPERBUS_CLK_DIV_EN_REG_OFFSET 0xf4
#define CARFIELD_HYPERBUS_CLK_DIV_EN_HYPERBUS_CLK_DIV_EN_BIT 0

// Hyperbus clock divider value
#define CARFIELD_HYPERBUS_CLK_DIV_VALUE_REG_OFFSET 0xf8
#define CARFIELD_HYPERBUS_CLK_DIV_VALUE_HYPERBUS_CLK_DIV_VALUE_MASK 0xfffff
...
#define CARFIELD_HOST_DEBUG_CLK_EN_REG_OFFSET 0x100
#define CARFIELD_HOST_DEBUG_CLK_EN_HOST_DEBUG_CLK_EN_BIT 0

// L2 domain debug clock divider (default active)
#define CARFIELD_L2_DEBUG_CLK_EN_REG_OFFSET 0x104
#define CARFIELD_L2_DEBUG_CLK_EN_L2_DEBUG_CLK_EN_BIT 0

// Safe domain debug clock divider (default active)
#define CARFIELD_SAFED_DEBUG_CLK_EN_REG_OFFSET 0x108
#define CARFIELD_SAFED_DEBUG_CLK_EN_SAFED_DEBUG_CLK_EN_BIT 0

// PULP domain debug clock divider (default active)
#define CARFIELD_PULPD_DEBUG_CLK_EN_REG_OFFSET 0x10c
#define CARFIELD_PULPD_DEBUG_CLK_EN_PULPD_DEBUG_CLK_EN_BIT 0

// Spatz domain debug clock divider (default active)
#define CARFIELD_SPATZD_DEBUG_CLK_EN_REG_OFFSET 0x110
#define CARFIELD_SPATZD_DEBUG_CLK_EN_SPATZD_DEBUG_CLK_EN_BIT 0

// Secure domain debug clock divider (default active)
#define CARFIELD_SECURED_DEBUG_CLK_EN_REG_OFFSET 0x114
#define CARFIELD_SECURED_DEBUG_CLK_EN_SECURED_DEBUG_CLK_EN_BIT 0

// Peripheral domain debug clock divider (default active)
#define CARFIELD_PERIPH_DEBUG_CLK_EN_REG_OFFSET 0x118
#define CARFIELD_PERIPH_DEBUG_CLK_EN_PERIPH_DEBUG_CLK_EN_BIT 0

// Host Domain debug clk divider value
#define CARFIELD_HOST_DEBUG_CLK_DIV_VALUE_REG_OFFSET 0x11c
#define CARFIELD_HOST_DEBUG_CLK_DIV_VALUE_HOST_DEBUG_CLK_DIV_VALUE_MASK 0xffffff
#define CARFIELD_HOST_DEBUG_CLK_DIV_VALUE_HOST_DEBUG_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_HOST_DEBUG_CLK_DIV_VALUE_HOST_DEBUG_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_HOST_DEBUG_CLK_DIV_VALUE_HOST_DEBUG_CLK_DIV_VALUE_MASK, .index = CARFIELD_HOST_DEBUG_CLK_DIV_VALUE_HOST_DEBUG_CLK_DIV_VALUE_OFFSET })

// L2 domain debug clk divider value
#define CARFIELD_L2_DEBUG_CLK_DIV_VALUE_REG_OFFSET 0x120
#define CARFIELD_L2_DEBUG_CLK_DIV_VALUE_L2_DEBUG_CLK_DIV_VALUE_MASK 0xffffff
#define CARFIELD_L2_DEBUG_CLK_DIV_VALUE_L2_DEBUG_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_L2_DEBUG_CLK_DIV_VALUE_L2_DEBUG_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_L2_DEBUG_CLK_DIV_VALUE_L2_DEBUG_CLK_DIV_VALUE_MASK, .index = CARFIELD_L2_DEBUG_CLK_DIV_VALUE_L2_DEBUG_CLK_DIV_VALUE_OFFSET })

// Safe Domain debug clk divider value
#define CARFIELD_SAFED_DEBUG_CLK_DIV_VALUE_REG_OFFSET 0x124
#define CARFIELD_SAFED_DEBUG_CLK_DIV_VALUE_SAFED_DEBUG_CLK_DIV_VALUE_MASK \
  0xffffff
#define CARFIELD_SAFED_DEBUG_CLK_DIV_VALUE_SAFED_DEBUG_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_SAFED_DEBUG_CLK_DIV_VALUE_SAFED_DEBUG_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_SAFED_DEBUG_CLK_DIV_VALUE_SAFED_DEBUG_CLK_DIV_VALUE_MASK, .index = CARFIELD_SAFED_DEBUG_CLK_DIV_VALUE_SAFED_DEBUG_CLK_DIV_VALUE_OFFSET })

// PULP Domain debug clk divider value
#define CARFIELD_PULPD_DEBUG_CLK_DIV_VALUE_REG_OFFSET 0x128
#define CARFIELD_PULPD_DEBUG_CLK_DIV_VALUE_PULPD_DEBUG_CLK_DIV_VALUE_MASK \
  0xffffff
#define CARFIELD_PULPD_DEBUG_CLK_DIV_VALUE_PULPD_DEBUG_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_PULPD_DEBUG_CLK_DIV_VALUE_PULPD_DEBUG_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_PULPD_DEBUG_CLK_DIV_VALUE_PULPD_DEBUG_CLK_DIV_VALUE_MASK, .index = CARFIELD_PULPD_DEBUG_CLK_DIV_VALUE_PULPD_DEBUG_CLK_DIV_VALUE_OFFSET })

// Spatz Domain debug clk divider value
#define CARFIELD_SPATZD_DEBUG_CLK_DIV_VALUE_REG_OFFSET 0x12c
#define CARFIELD_SPATZD_DEBUG_CLK_DIV_VALUE_SPATZD_DEBUG_CLK_DIV_VALUE_MASK \
  0xffffff
#define CARFIELD_SPATZD_DEBUG_CLK_DIV_VALUE_SPATZD_DEBUG_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_SPATZD_DEBUG_CLK_DIV_VALUE_SPATZD_DEBUG_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_SPATZD_DEBUG_CLK_DIV_VALUE_SPATZD_DEBUG_CLK_DIV_VALUE_MASK, .index = CARFIELD_SPATZD_DEBUG_CLK_DIV_VALUE_SPATZD_DEBUG_CLK_DIV_VALUE_OFFSET })

// Secure Domain debug clk divider value
#define CARFIELD_SECURED_DEBUG_CLK_DIV_VALUE_REG_OFFSET 0x130
#define CARFIELD_SECURED_DEBUG_CLK_DIV_VALUE_SECURED_DEBUG_CLK_DIV_VALUE_MASK \
  0xffffff
#define CARFIELD_SECURED_DEBUG_CLK_DIV_VALUE_SECURED_DEBUG_CLK_DIV_VALUE_OFFSET \
  0
#define CARFIELD_SECURED_DEBUG_CLK_DIV_VALUE_SECURED_DEBUG_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_SECURED_DEBUG_CLK_DIV_VALUE_SECURED_DEBUG_CLK_DIV_VALUE_MASK, .index = CARFIELD_SECURED_DEBUG_CLK_DIV_VALUE_SECURED_DEBUG_CLK_DIV_VALUE_OFFSET })

// Peripheral Domain debug clk divider value
#define CARFIELD_PERIPH_DEBUG_CLK_DIV_VALUE_REG_OFFSET 0x134
#define CARFIELD_PERIPH_DEBUG_CLK_DIV_VALUE_PERIPH_DEBUG_CLK_DIV_VALUE_MASK \
  0xffffff
#define CARFIELD_PERIPH_DEBUG_CLK_DIV_VALUE_PERIPH_DEBUG_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_PERIPH_DEBUG_CLK_DIV_VALUE_PERIPH_DEBUG_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_PERIPH_DEBUG_CLK_DIV_VALUE_PERIPH_DEBUG_CLK_DIV_VALUE_MASK, .index = CARFIELD_PERIPH_DEBUG_CLK_DIV_VALUE_PERIPH_DEBUG_CLK_DIV_VALUE_OFFSET })

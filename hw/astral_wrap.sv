...
#(
  ...
  // hyper bus 0
  assign st_soc2pad_signals.botl.hyper_ck_no_0      = hyperbus_clk_no_s[0];
  assign st_soc2pad_signals.botl.hyper_ck_o_0       = hyperbus_clk_o_s[0];
  assign st_soc2pad_signals.botl.hyper_cs_no_0_0    = hyperbus_cs_no_s[0][0];
  assign st_soc2pad_signals.botl.hyper_cs_no_0_1    = hyperbus_cs_no_s[0][1];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_0     = hyperbus_data_out_s[0][0];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_1     = hyperbus_data_out_s[0][1];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_2     = hyperbus_data_out_s[0][2];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_3     = hyperbus_data_out_s[0][3];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_4     = hyperbus_data_out_s[0][4];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_5     = hyperbus_data_out_s[0][5];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_6     = hyperbus_data_out_s[0][6];
  assign st_soc2pad_signals.botl.hyper_dq_o_0_7     = hyperbus_data_out_s[0][7];
  assign st_soc2pad_signals.botl.hyper_dq_oen_i_0   = hyperbus_data_oe_s[0];
  assign st_soc2pad_signals.botl.hyper_reset_no_0   = hyperbus_rst_no_s[0];
  assign st_soc2pad_signals.botl.hyper_rwds_o_0     = hyperbus_rwds_out_s[0];
  assign st_soc2pad_signals.botl.hyper_rwds_oen_i_0 = hyperbus_rwds_oe_s[0];
  // hyper bus 1
  assign st_soc2pad_signals.botl.hyper_ck_no_1      = hyperbus_clk_no_s[1];
  assign st_soc2pad_signals.botl.hyper_ck_o_1       = hyperbus_clk_o_s[1];
  assign st_soc2pad_signals.botl.hyper_cs_no_1_0    = hyperbus_cs_no_s[1][0];
  assign st_soc2pad_signals.botl.hyper_cs_no_1_1    = hyperbus_cs_no_s[1][1];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_0     = hyperbus_data_out_s[1][0];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_1     = hyperbus_data_out_s[1][1];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_2     = hyperbus_data_out_s[1][2];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_3     = hyperbus_data_out_s[1][3];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_4     = hyperbus_data_out_s[1][4];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_5     = hyperbus_data_out_s[1][5];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_6     = hyperbus_data_out_s[1][6];
  assign st_soc2pad_signals.botl.hyper_dq_o_1_7     = hyperbus_data_out_s[1][7];
  assign st_soc2pad_signals.botl.hyper_dq_oen_i_1   = hyperbus_data_oe_s[1];
  assign st_soc2pad_signals.botl.hyper_reset_no_1   = hyperbus_rst_no_s[1];
  assign st_soc2pad_signals.botl.hyper_rwds_o_1     = hyperbus_rwds_out_s[1];
  assign st_soc2pad_signals.botl.hyper_rwds_oen_i_1 = hyperbus_rwds_oe_s[1];

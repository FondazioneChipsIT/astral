...
package tc_pad_pkg;
    ...
    typedef struct packed {
        ...
        bit          pu_en_ah;               // pull up enable active high
        bit          pd_en_ah;               // pull down enable active high
        bit          pu_pd_both_en;          // both pull up and pull down can be both enable at the same time
        bit          st_en_ah;               // Schmitt trigger enable active high
        bit          rt_en_ah;               // retention enable active high
